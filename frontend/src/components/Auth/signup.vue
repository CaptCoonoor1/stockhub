  ...
  <div class="signup-form">
    <form>
      <fieldset>
        ...
        <p v-if="this.invalidName" style="color: red">Name is Required</p>
        <label for="name">Name:</label>
        <input type="text" name="name" v-model="name" placeholder="Your Name *" />

        <p v-if="this.invalidEmail" style="color: red">Please Enter a Valid Email</p>
        <p v-if="this.emailInUse" style="color: red">Please Enter a Different Email</p>
        ...
        <p v-if="this.samePassword" style="color: red">Passwords do not match</p>
  ...
  methods: {
    submitForm() {
      ...
      if (!flag) {
        ...
        setTimeout(() => {
          if (this.$store.getters.emailTaken) this.emailInUse = true;
          else {
